...
public class ShowActivity extends AppCompatActivity implements ShowAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcvAll = findViewById(R.id.rcvAll);
        list = new ArrayList<>();
        ...
        rcvAll.setLayoutManager(new LinearLayoutManager(this));
        rcvAll.setItemAnimator(new DefaultItemAnimator());
        showAdapter.addItemClickListener(this);
        rcvAll.setAdapter(showAdapter);
